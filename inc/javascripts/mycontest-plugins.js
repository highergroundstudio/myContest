...
(function (window, document, $, undefined) {
    ...
    $.extend(F, {
        ...
        defaults: {
            ...
            // HTML templates
            tpl: {
                wrap     : '<div class="myContestbox-wrap" tabIndex="-1"><div class="myContestbox-skin"><div class="myContestbox-outer"><div class="myContestbox-inner"></div></div></div></div>',
                image    : '<img class="myContestbox-image" src="{href}" alt="" />',
                iframe   : '<iframe id="myContestbox-frame{rnd}" name="myContestbox-frame{rnd}" class="myContestbox-iframe" frameborder="0" vspace="0" hspace="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen' + (IE ? ' allowtransparency="true"' : '') + '></iframe>',
                error    : '<p class="myContestbox-error">The requested content cannot be loaded.<br/>Please try again later.</p>',
                closeBtn : '<a title="Close" class="myContestbox-item myContestbox-close" href="javascript:;"></a>',
                next     : '<a title="Next" class="myContestbox-nav myContestbox-next" href="javascript:;"><span></span></a>',
                prev     : '<a title="Previous" class="myContestbox-nav myContestbox-prev" href="javascript:;"><span></span></a>'
            },

            // Properties for each animation type
            // Opening myContestbox
        ...
        open: function (group, opts) {
            ...
            $.each(group, function(i, element) {
                ...
                if ($.type(element) === "object") {
                    ...
                    if (isQuery(element)) {
                        obj = {
                            href    : element.data('myContestbox-href') || element.attr('href'),
                            title   : element.data('myContestbox-title') || element.data('title'),
                            isDom   : true,
                            element : element
                        };
                ...
                if (!type && obj.isDom) {
                    type = element.data('myContestbox-type');

                    if (!type) {
                        rez  = element.prop('class').match(/myContestbox\.(\w+)/);
                        type = rez ? rez[1] : null;
                    }
                }
        ...
        close: function (event) {
            ...
            if (!F.isOpen || event === true) {
                $('.myContestbox-wrap').stop(true).trigger('onReset').remove();
                ...
                $('.myContestbox-item, .myContestbox-nav').remove();

                F.wrap.stop(true, true).removeClass('myContestbox-opened');
        ...
        // Manage slideshow:
        //   $.myContestbox.play(); - toggle slideshow
        //   $.myContestbox.play( true ); - start
        //   $.myContestbox.play( false ); - stop
        ...
        update: function (e) {
            ...
            didUpdate = setTimeout(function() {
                ...
                F.wrap.removeClass('myContestbox-tmp');
        ...
        toggle: function ( action ) {
            if (F.isOpen) {
                ...
                if (isTouch) {
                    F.wrap.removeAttr('style').addClass('myContestbox-tmp');
        ...
        showLoading: function () {
            ...
            el = $('<div id="myContestbox-loading"><div></div></div>').click(F.cancel).appendTo('body');
        ...
        bindEvents: function () {
            ...
            if ($.fn.mousewheel && current.mouseWheel) {
                F.wrap.bind('mousewheel.fb', function (e, delta, deltaX, deltaY) {
                    ...
                    while (parent.length) {
                        if (canScroll || parent.is('.myContestbox-skin') || parent.is('.myContestbox-wrap')) {
                            break;
                        }
        ...
        _start: function (index) {
            ...
            coming.wrap = $(coming.tpl.wrap).addClass('myContestbox-' + (isTouch ? 'mobile' : 'desktop') + ' myContestbox-type-' + type + ' myContestbox-tmp ' + coming.wrapCSS).appendTo( coming.parent || 'body' );

            $.extend(coming, {
                skin  : $('.myContestbox-skin',  coming.wrap),
                outer : $('.myContestbox-outer', coming.wrap),
                inner : $('.myContestbox-inner', coming.wrap)
            });
        ...
        _loadIframe: function() {
            ...
            if (coming.iframe.preload) {
                ...
                iframe.one('load', function() {
                    ...
                    $(this).parents('.myContestbox-wrap').width('100%').removeClass('myContestbox-tmp').show();
        ...
        _afterLoad: function () {
            var coming   = F.coming,
                previous = F.current,
                placeholder = 'myContestbox-placeholder',
                current,
                content,
                type,
                scrolling,
            ...
            if (previous) {
                ...
                previous.wrap.stop(true).removeClass('myContestbox-opened')
                    .find('.myContestbox-item, .myContestbox-nav')
                    .remove();
            }
            ...
            switch (type) {
                ...
                case 'swf':
                    content = '<object id="myContestbox-swf" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="100%" height="100%"><param name="movie" value="' + href + '"></param>';
                    embed   = '';
            ...
            if (!F.isOpened) {
                $('.myContestbox-wrap').not( current.wrap ).stop(true).trigger('onReset').remove();
        ...
        _setDimension: function () {
            ...
            wrap.add(skin).add(inner).width('auto').height('auto').removeClass('myContestbox-tmp');
            ...
            if (current.type === 'iframe') {
                ...
                inner.addClass( 'myContestbox-tmp' );
                ...
                inner.removeClass( 'myContestbox-tmp' );
            }
        ...
        _afterZoomIn: function () {
            ...
            F.wrap.css('overflow', 'visible').addClass('myContestbox-opened');
        ...
        _afterZoomOut: function ( obj ) {
            ...
            $('.myContestbox-wrap').trigger('onReset').remove();
    ...
    F.helpers.overlay = {
        defaults : {
            closeClick : true,  // if true, myContestbox will be closed when user clicks on the overlay
        ...
        create : function(opts) {
            ...
            this.overlay = $('<div class="myContestbox-overlay"></div>').appendTo( 'body' );
            this.fixed   = false;

            if (opts.fixed && F.defaults.fixed) {
                this.overlay.addClass('myContestbox-overlay-fixed');
        ...
        open : function(opts) {
            ...
            if (opts.closeClick) {
                this.overlay.bind('click.overlay', function(e) {
                    if ($(e.target).hasClass('myContestbox-overlay')) {
                        if (F.isActive) {
                            F.close();
                        } else {
                            that.close();
        ...
        close : function() {
            ...
            if (this.el) {
                this.el.removeClass('myContestbox-lock');
            }
        },
        ...
        onReady : function (opts, obj) {
            $('.myContestbox-overlay').stop(true, true);
        ...
        beforeShow : function(opts, obj) {
            if (obj.locked) {
                this.el.addClass('myContestbox-lock');
        ...
        afterClose: function (opts) {
            // Remove overlay if exists and myContestbox is not opening
    ...
    F.helpers.title = {
        ...
        beforeShow: function (opts) {
            ...
            title = $('<div class="myContestbox-title myContestbox-title-' + type + '-wrap">' + text + '</div>');
    ...
    $.fn.myContestbox = function (options) {
        var index,
            that     = $(this),
            ...
            run      = function(e) {
                ...
                if (!(e.ctrlKey || e.altKey || e.shiftKey || e.metaKey) && !what.is('.myContestbox-wrap')) {
                    relType = options.groupAttr || 'data-myContestbox-group';
        ...
        if (!selector || options.live === false) {
            ...
            D.undelegate(selector, 'click.fb-start').delegate(selector + ":not('.myContestbox-item, .myContestbox-nav')", 'click.fb-start', run);
        }

        this.filter('[data-myContestbox-start=1]').trigger('click');
